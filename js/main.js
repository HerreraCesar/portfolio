...
comenzar.addEventListener("click", function () {
  ...
  window.addEventListener("wheel", (e) => {
    ...
    if (progress >= 6875) {
      ...
      curtain.style.boxShadow = `-${(progress-6750)/360}vw 0px 30px black`
    }
    if (progress >= 10000) {
      about.innerHTML=''
    ...
    if (progress >= 11625) {
      technologies.style.transform = `translateY(${(600 + (progress-11625)/-4)}px)`
      back.style.transform = `translateY(${(500 + (progress-11625)/-5.85)}px)`
    }
    if (progress >= 31625) {
