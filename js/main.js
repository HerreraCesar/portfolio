...
comenzar.addEventListener("click", () => {
  ...
  setTimeout(() => {
    instruction.innerHTML = "<p>desplazarse para continuar</p>";
    instruction.style.display = "flex";
    // AVANCE SCROLL
    let progress = 1;
    let ratio = screen.width / screen.height;
    ...
    window.addEventListener("wheel", (e) => {
      ...
      progressBar.style.width = `${(progress * 100) / 449}%`;
      if (ratio < 1.25) {
        if (progress < 10) {
        ...
        if (progress >= 13) {
          text.innerHTML = base + "/so";
        }
        if (progress >= 14) {
          text.innerHTML = base + "/sob";
        }
        if (progress >= 15) {
          text.innerHTML = base + "/sobr";
        }
        if (progress >= 16) {
          text.innerHTML = base + "/sobre";
        }
        if (progress >= 17) {
          text.innerHTML = base + "/sobre_";
        }
        if (progress >= 18) {
          text.innerHTML = base + "/sobre_m";
        }
        if (progress >= 19) {
          text.innerHTML = base + "/sobre_mi";
          about.style.opacity = 0;
        }
        if (progress >= 20) {
          about.innerHTML = `
        ...
        if (progress >= 78) {
          document.querySelector("#name").style.fontFamily = "Roboto Mono";
          curtain.style.left = `calc(50vw - ${progress - 78}vh)`;
          curtain.style.top = `calc(50vh - ${progress - 78}vh)`;
          curtain.style.width = `${(progress - 78) * 2}vh`;
          curtain.style.height = `${(progress - 78) * 2}vh`;
        }
        if (progress >= 130) {
          about.innerHTML = "";
          curtain.style.width = 0;
        ...
        if (progress >= 142) {
          text.innerHTML = base + "/h";
        }
        if (progress >= 143) {
          text.innerHTML = base + "/ha";
        }
        if (progress >= 144) {
          text.innerHTML = base + "/hab";
        }
        if (progress >= 145) {
          text.innerHTML = base + "/habi";
        }
        if (progress >= 146) {
          text.innerHTML = base + "/habil";
        }
        if (progress >= 147) {
          text.innerHTML = base + "/habili";
        }
        if (progress >= 148) {
          text.innerHTML = base + "/habilid";
        }
        if (progress >= 149) {
          text.innerHTML = base + "/habilida";
        }
        if (progress >= 150) {
          text.innerHTML = base + "/habilidad";
        }
        if (progress >= 151) {
          text.innerHTML = base + "/habilidade";
        }
        if (progress >= 152) {
          text.innerHTML = base + "/habilidades";
          skills.style.display = "none";
          technologies.innerHTML = "";
        }
        if (progress >= 153) {
        ...
        if (progress >= 154) {
          ...
          back.style.transform = `translateY(${65 + (progress - 154) * -4}vh)`;
        }
        if (progress >= 286) {
          technologies.style.transform = `translateY(-697vh)`;
          back.style.transform = `translateY(-463vh)`;
        ...
        if (progress >= 307) {
          text.innerHTML = base + "/experienci";
        }
        if (progress >= 308) {
          text.innerHTML = base + "/experiencia";
        }
        if (progress >= 309) {
          text.innerHTML = base + "/experiencias";
        }
        if (progress >= 310) {
          experiences.style.zIndex = 1;
          experiences.innerHTML = `
            <div class='project'>
              <div  class='screenshot'>
                ...
                <div class='links'>
                  <div>
                    <h3>Stail Iluminación</h3>
                    <p>Sitio web realizado durante el desarrollo del curso Desarrollo Web de Coderhouse.</p>
                  </div>
                  <div>
                    <a href='https://github.com/HerreraCesar/lighting-store' target='_blank'>_Repositorio </a>
                    <a href='https://stail.netlify.app/' target='_blank'>_Despliegue </a>
                  </div>
                </div>
              </div>
              <h3>Stail Iluminación</h3>
            ...
            <div class='project'>
              <div  class='screenshot'>
                ...
                <div class='links'>
                  <div>
                    <h3>Ser Galgos</h3>
                    <p>Realización de sitio web con HTML, CSS y JavaScript Vanilla para Ser Galgos.</p>
                  </div>
                  <div>
                    <a href='https://github.com/HerreraCesar/ser-galgos' target='_blank'>_Repositorio </a>
                    <a href='https://sergalgos.netlify.app/' target='_blank'>_Despliegue </a>
                  </div>
                </div>
              </div>
              <h3>Ser Galgos</h3>
            ...
            <div class='project'>
              <div class='screenshot'>
                ...
                <div class='links'>
                  <div>
                    <h3>1000 Movies</h3>
                    <p>Sitio web realizado durante el desarrollo del curso JavaScript de Coderhouse.</p>
                  </div>
                  <div>
                    <a href='https://github.com/HerreraCesar/movies-website' target='_blank'>_Repositorio </a>
                    <a href='https://milpelis.netlify.app/' target='_blank'>_Despliegue </a>
                  </div>
                </div>
              </div>
              <h3>1000 Movies</h3>
            ...
            <div class='project'>
              <div class='screenshot'>
                ...
                <div class='links'>
                  <div>
                    <h3>Pcentrix</h3>
                    <p>Realización de landing page con HTML, SASS y JavaScript Vanilla para Pcentrix.</p>
                  </div>
                  <div>
                    <a href='https://github.com/HerreraCesar/pcentrix' target='_blank'>_Repositorio </a>
                    <a href='https://pcentrix.netlify.app/' target='_blank'>_Despliegue </a>
                  </div>
                </div>
              </div>
              <h3>Pcentrix</h3>
            ...
            <div class='project'>
              <div  class='screenshot'>
                ...
                <div class='links'>
                  <div>
                    <h3>Basics Store</h3>
                    <p>E-commerce realizado durante el desarrollo del curso React JS de Coderhouse.</p>
                  </div>
                  <div>
                    <a href='https://github.com/HerreraCesar/basics-store' target='_blank'>_Repositorio </a>
                    <a href='https://basics-store.netlify.app/' target='_blank'>_Despliegue </a>
                  </div>
                </div>
              </div>
              <h3>Basics Store</h3>
        ...
        if (progress >= 407) {
          text.innerHTML = base + "/contacto";
        }
        if (progress >= 408) {
          form.innerHTML = `<h2>¡Hablemos!</h2>
          <h1 onclick="copyToClipboard()">
            herrera.cesar.arg@gmail.com
            <img src="./assets/icons/clone.svg" alt="" />
          </h1>
        ...
        if (progress >= 449) {
          form.style.transform = `scale(1) translateX(0px) translateY(-5px)`;
          instruction.innerHTML = "<p>gracias por su visita</p>";
          instruction.style.animation = "none";
        }
      } else {
        if (progress < 10) {
        ...
        if (progress >= 78) {
          ...
          document.querySelector("#profile").style.opacity = 0;
          document.querySelector("#profile").style.width = 0;
          curtain.style.top = `calc(50vh - (${(progress - 78) * 2}vw)/2)`;
          curtain.style.width = `${(progress - 78) * 2}vw`;
          curtain.style.height = `${(progress - 78) * 2}vw`;
          curtain.style.boxShadow = `-${(progress - 78) / 6}vw 0px 30px black`;
        }
        if (progress >= 130) {
          about.innerHTML = "";
          curtain.style.width = 0;
